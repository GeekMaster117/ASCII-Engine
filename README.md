...
--> Method - bounceOfMultiple() - Checks whether the entity is colliding with an of the entity passes as an array, and bounces of it; arguments - Entity array; return type - void
